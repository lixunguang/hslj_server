...
func GetAreaLocationList(ctx *gin.Context, param dto.GetLocationListParam) ([]dto.LocationRes, cerror.Cerror) {
	var res []dto.LocationRes

	location, err := dao.GetAreaLocationList(ctx, param.LocationCode)
